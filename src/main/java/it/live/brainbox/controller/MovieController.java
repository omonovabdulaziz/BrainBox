...
public class MovieController {
    ...
    public Page<?> getAllMoviePage(@RequestParam int page, @RequestParam int size, @RequestParam(value = "level", required = false) Level level, @RequestParam(value = "genre", required = false) String genre) {
        return movieService.getAllMoviePage(page, size, level, genre);
    }
