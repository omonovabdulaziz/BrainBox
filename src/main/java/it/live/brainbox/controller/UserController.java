...
public class UserController {
    ...
    public ResponseEntity<ApiResponse> updateUser(@RequestParam Long userId, @RequestBody(required = false) UserDTO userDTO , @RequestParam boolean addCoin) {
        return userService.updateUser(userId, userDTO , addCoin);
    }
